...
#[test]
#[ignore]
fn test_negative_one_twenty_minutes_is_prev_hour() {
    assert_eq!(Clock::new(3, -120).to_string(), "01:00");
}
...
#[test]
#[ignore]
fn test_subtract_mores_than_three_days() {
    let clock = Clock::new(-72, 40);
    assert_eq!(clock.to_string(), "00:40");
}
